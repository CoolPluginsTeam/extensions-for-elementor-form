...
= 2.7.8 - 2026-09-21 =
* Fixed: WhatsApp Redirect `%break%` line breaks not preserved in the redirect URL.
* Fixed: Extra spacing when WhatsApp Message used both editor line breaks and `%break%`.
