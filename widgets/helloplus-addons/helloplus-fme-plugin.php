...
final class HelloPlus_FME_Plugin {
	...
	protected function get_custom_mask_script_handle(): string {
		return 'helloplus-fme-custom-mask-script';
	}

	protected function get_frontend_style_handle(): string {
		return 'helloplus-fme-frontend-css';
	}

	protected function get_input_mask_script_handle(): string {
		return 'helloplus-fme-new-input-mask';
	}

	protected function get_input_mask_script_src(): string {
		return CFL_PLUGIN_URL . 'assets/helloplus-addons/js/helloplus-new-input-mask.js';
	}

	protected function get_editor_template_script_handle(): string {
		return 'helloplus-fme-editor-template-js';
	}
	...
	protected function get_mask_control_file(): string {
		return CFL_PLUGIN_PATH . 'widgets/helloplus-addons/helloplus-elementor-mask-control.php';
	}
