        ...
        <div class="cfkef-wrapper">
            <div class="cfkef-header">
                ...
                <div class="cfkef-header-buttons">
                    ...
                    <a href="https://docs.coolplugins.net/plugin/cool-formkit-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=doc&utm_content=setting-page-header" class="button" target="_blank"><?php esc_html_e('Check Docs', 'cool-formkit'); ?></a>
