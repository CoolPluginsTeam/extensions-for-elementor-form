...
class Review_notice
{
	...
	{
		$html = '
		<div data-ajax-url="' . esc_url(admin_url('admin-ajax.php')) . '" data-nonce="' . wp_create_nonce('cfl_elementor_review') . '" data-ajax-callback="' . esc_attr($this->plugin_slug) . '_dismiss_notice" class="' . esc_attr($this->plugin_slug) . '-review-notice-wrapper notice notice-info is-dismissible">
